...
void MPU6050::BaseInititalize () {
	...
	this->RegisterWrite(MPU6050_GYRO_CONFIG, 0x08); //  0x00:250, 0x08:500, 0x10:1000, 0x18:2000deg/s

	// Setting accelerometer self-test and full scale range
	this->RegisterWrite(MPU6050_ACCEL_CONFIG, 0x18); //  0x00:2g, 0x08:4g, 0x10:8g, 0x18:16g
